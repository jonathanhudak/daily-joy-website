<div class="max-width-section px2 py4">
  ...
  <p>
    ...
    Welcome to our online store! Daily Joy, SPC and its associates provide their
    services to you subject to the following conditions. If you visit or shop
    within this website, you accept these conditions. Please read them
    carefully.
  </p>
  ...
  <p>
    ...
    When you visit Daily Joy, SPC or send e-mails to us, you are communicating
  ...
  <p>
    ...
    software, is the property of Daily Joy, SPC or its content suppliers and
    protected by international copyright laws. The compilation of all content on
    this site is the exclusive property of Daily Joy, SPC, with copyright
    authorship for this collection by Daily Joy, SPC, and protected by
  ...
  <p>
    ...
    Daily Joy, SPCs trademarks and trade dress may not be used in connection
    with any product or service that is not Daily Joy, SPCs, in any manner that
    is likely to cause confusion among customers, or in any manner that
    disparages or discredits Daily Joy, SPC. All other trademarks not owned by
    Daily Joy, SPC or its subsidiaries that appear on this site are the property
    of their respective owners, who may or may not be affiliated with, connected
    to, or sponsored by Daily Joy, SPC or its subsidiaries.
  </p>
  ...
  <p>
    ...
    Daily Joy, SPC grants you a limited license to access and make personal use
    of this site and not to download (other than page caching) or modify it, or
    any portion of it, except with express written consent of Daily Joy, SPC.
    This license does not include any resale or commercial use of this site or
    its contents: any collection and use of any product listings, descriptions,
    or prices: any derivative use of this site or its contents: any downloading
    ...
    commercial purpose without express written consent of Daily Joy, SPC. You
    may not frame or utilize framing techniques to enclose any trademark, logo,
    or other proprietary information (including images, text, page layout, or
    form) of Daily Joy, SPC and our associates without express written consent.
    You may not use any meta tags or any other &#8220;hidden text&#8221;
    utilizing Daily Joy, SPCs name or trademarks without the express written
    consent of Daily Joy, SPC. Any unauthorized use terminates the permission or
    license granted by Daily Joy, SPC. You are granted a limited, revocable, and
    nonexclusive right to create a hyperlink to the home page of Daily Joy, SPC
    so long as the link does not portray Daily Joy, SPC, its associates, or
    their products or services in a false, misleading, derogatory, or otherwise
    offensive matter. You may not use any Daily Joy, SPC logo or other
  ...
  <p>
    ...
    that occur under your account or password. If you are under 18, you may use
    our website only with involvement of a parent or guardian. Daily Joy, SPC
    and its associates reserve the right to refuse service, terminate accounts,
  ...
  <p>
    ...
    suggestions, ideas, comments, questions, or other information, so long as
    the content is not illegal, obscene, threatening, defamatory, invasive of
    privacy, infringing of intellectual property rights, or otherwise injurious
    ...
    as to the origin of a card or other content. Daily Joy, SPC reserves the
    right (but not the obligation) to remove or edit such content, but does not
    regularly review posted content. If you do post content or submit material,
    and unless we indicate otherwise, you grant Daily Joy, SPC and its
    associates a nonexclusive, royalty-free, perpetual, irrevocable, and fully
    ...
    throughout the world in any media. You grant Daily Joy, SPC and its
    associates and sublicensees the right to use the name that you submit in
    connection with such content, if they choose. You represent and warrant that
    ...
    violate this policy and will not cause injury to any person or entity: and
    that you will indemnify Daily Joy, SPC or its associates for all claims
    resulting from content you supply. Daily Joy, SPC has the right but not the
    obligation to monitor and edit or remove any activity or content. Daily Joy,
    SPC takes no responsibility and assumes no liability for any content posted
  ...
  <p>
    ...
    All items purchased from Daily Joy, SPC are made pursuant to a shipment
    contract. This basically means that the risk of loss and title for such
  ...
  <p>
    ...
    Daily Joy, SPC and its associates attempt to be as accurate as possible.
    However, Daily Joy, SPC does not warrant that product descriptions or other
    content of this site is accurate, complete, reliable, current, or
    error-free. If a product offered by Daily Joy, SPC itself is not as
    described, your sole remedy is to return it in unused condition. DISCLAIMER
    OF WARRANTIES AND LIMITATION OF LIABILITY THIS SITE IS PROVIDED BY Daily
    Joy, SPC ON AN &#8220;AS IS&#8221; AND &#8220;AS AVAILABLE&#8221; BASIS.
    Daily Joy, SPC MAKES NO REPRESENTATIONS OR WARRANTIES OF ANY KIND, EXPRESS
    OR IMPLIED, AS TO THE OPERATION OF THIS SITE OR THE INFORMATION, CONTENT,
    ...
    APPLICABLE LAW, Daily Joy, SPC DISCLAIMS ALL WARRANTIES, EXPRESS OR IMPLIED,
    INCLUDING, BUT NOT LIMITED TO, IMPLIED WARRANTIES OF MERCHANTABILITY AND
    FITNESS FOR A PARTICULAR PURPOSE. Daily Joy, SPC DOES NOT WARRANT THAT THIS
    SITE, ITS SERVERS, OR E-MAIL SENT FROM Daily Joy, SPC ARE FREE OF VIRUSES OR
    OTHER HARMFUL COMPONENTS. Daily Joy, SPC WILL NOT BE LIABLE FOR ANY DAMAGES
    OF ANY KIND ARISING FROM THE USE OF THIS SITE, INCLUDING, BUT NOT LIMITED TO
    DIRECT, INDIRECT, INCIDENTAL, PUNITIVE, AND CONSEQUENTIAL DAMAGES. CERTAIN
  ...
  <p>
    ...
    Please review our other policies, such as our Shipping and Returns policy,
    posted on this site. These policies also govern your visit to Daily Joy,
    SPC. We reserve the right to make changes to our site, policies, and these
